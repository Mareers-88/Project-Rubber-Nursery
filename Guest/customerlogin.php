...
<body>
		...
		<div class="w3ls-login box">
			...
			<form action="customerloginaction.php" method="post">
				<div class="agile-field-txt">
					<input type="text" name="txtemailid" placeholder="email" required="" />
				</div>
				<div class="agile-field-txt">
					<input type="text" name="txtpassword" placeholder="******" required="" id="myInput" />
	...
	<script src='Adminjs/particles.min.js'></script>
