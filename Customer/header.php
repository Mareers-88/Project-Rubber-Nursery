...
<head>
	<title>Garden Care an Agriculture Category Bootstrap Responsive web Template | Home :: w3layouts</title>
	<!-- Meta tag Keywords -->
	...
	<div class="banner">
				...
				<div class="overlay overlay-boxes">
					...
					<nav>
						<ul>
							...
							<li><a href="customerreg.php" >Sign Up</a></li>
		...
		<div class="w3layouts_banner_info">
			<section class="wrapper agileits-w3layouts_wrapper_home text-center">
				<h1 class="w3l-logo"><a href="index.html"><i class="fa fa-envira" aria-hidden="true"></i>BOOK YOUR PLANT</a></h1>
